...
import { createComment, editComment, getPostComments, likeComment ,deleteComment, getAllComments} from '../controllers/comment.controller.js';
...
router.route('/getcomments').get(verifyUser,getAllComments);
